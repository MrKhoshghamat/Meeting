...
public partial class Build
{
    ...
    const string SqlServerPassword = "Dpk@12345";
    ...
    Target PrepareSqlServer => _ => _
        ...
        .Executes(() =>
        {
            ...
            SqlReadinessChecker.WaitForSqlSever(
                $"Server=DPK-147\\\\SQL2019;Database=MyMeetings;User={SqlServerUser};Password={SqlServerPassword};Encrypt=False;TrustServerCertificate=True");
        });
